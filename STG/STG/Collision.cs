...
namespace STG
{
    public class Collision
    {
        ...
        static int CELLWIDTH = (MainGame.PlayingArea.Width + 100) / ROWS, CELLHEIGHT = (MainGame.PlayingArea.Height + 100) / COLUMNS;//constants for the size of the collision grid as well as the cell dimensions
