...
namespace STG
{
    public class Collision
    {
        ...
        static int CELLWIDTH = (MainGame.PlayingArea.Width) / ROWS, CELLHEIGHT = (MainGame.PlayingArea.Height) / COLUMNS;//constants for the size of the collision grid as well as the cell dimensions
