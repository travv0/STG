...
namespace STG
{
    public class Collision
    {
        ...
        static int CELLWIDTH = (MainGame.PlayingArea.Width + 500) / ROWS, CELLHEIGHT = (MainGame.PlayingArea.Height + 500) / COLUMNS;//constants for the size of the collision grid as well as the cell dimensions
